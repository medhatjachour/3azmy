...
class PyLeftMenuButton(QPushButton):
    ...
    def paintEvent(self, event):
        ...
        if self.settings["language"] == "english":
            ...
            rect_inside = QRect(4, 5, self.width() - 8, self.height() - 10) #hover
            ...
            rect_inside = QRect(4, 5, self.width() - 8, self.height() - 10)#hover
            rect_icon = QRect(0, 0, 50, self.height())
            rect_blue = QRect(36, 5, 20, self.height() - 10)
            rect_inside_active = QRect(-7, 5, self.width(), self.height() - 10)#
            rect_text = QRect(45, 0, self.width() - 50, self.height())
...
class _ToolTip(QLabel):
    ...
    def __init__(
        ...
        if self.settings["language"] == "english":
            ...
            # LABEL SETUP
            style = self.style_tooltip_arabic.format(
                _dark_one = dark_one,
                _context_color = context_color,
                _text_foreground = text_foreground
            )
