...
class PyTitleBar(QWidget):
    ...
    # SETUP UI
        ...
        #self.search.setStyleSheet(f"background-color: {bg_color}; border-radius: {radius}px;")
        ...
        # ////////////////////////////////////////////////////////////////// CHABGE ORDERS IN ORDER THE LANGUAG E IS
        if self.settings["language"] == "english":
            ...
            # Extra BTNs layout
            self.bg_layout.addLayout(self.custom_buttons_layout)# ADD Buttons
    ...
    def setup_ui(self):
        ...
        #ADD SREACH 
        #self.search = QFrame()
        #self.search.setMinimumHeight(5)
        #self.search.setStyleSheet("background-color:#555")
        #self.title_bar_layout.addWidget(self.search)
        ...
        if self.settings["language"] == "english":
            ...
            self.title_label.setContentsMargins(0,8,0,0)
