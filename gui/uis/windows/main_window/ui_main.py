...
# RIGHT COLUMN
# ///////////////////////////////////////////////////////////////
from gui.uis.columns.ui_search_area import Ui_Search_area
...
class UI_MainWindow(object):
    def setup_ui(self, parent):
        ...
        self.title_bar_frame.setMaximumHeight(40)# from 40 to 90  
        ...
        self.title_bar = PyTitleBar(
            ...
            btn_bg_color_pressed = self.themes["app_color"]["icon_color_title"],
            icon_color = self.themes["app_color"]["icon_color_title"],
            icon_color_hover = self.themes["app_color"]["icon_hover"],
            icon_color_pressed = self.themes["app_color"]["icon_pressed"],
            icon_color_active = self.themes["app_color"]["icon_active"],
            context_color = self.themes["app_color"]["context_color"],
        ...
        # SEARCH BAR
        self.search_area_frame = QFrame()
        self.search_area_frame.setMinimumHeight(self.settings["search_area_size"]["minimum"])
        self.search_area_frame.setMaximumHeight(self.settings["search_area_size"]["maximum"])

        # IMPORT SEARCH 
        # ///////////////////////////////////////////////////////////////
        self.content_area_search_layout = QHBoxLayout(self.search_area_frame)
        self.content_area_search_layout.setContentsMargins(0,0,0,0)
        self.content_area_search_layout.setSpacing(0)


        # search BG
        self.content_area_search_bg_frame = QFrame()
        self.content_area_search_bg_frame.setObjectName("content_area_search_bg_frame")
        self.content_area_search_bg_frame.setStyleSheet(f'''
        #content_area_search_bg_frame {{
            border-radius: 8px;
            background-color: {self.themes["app_color"]["bg_two"]};
        }}
        ''')
        ...
        # ADD BG
        self.content_area_search_layout.addWidget(self.content_area_search_bg_frame)

        # ADD search PAGES TO search COLUMN
        self.search_area = Ui_Search_area()
        self.search_area.setupUi(self.content_area_search_bg_frame)

        # ADD TO LAYOUTS
        self.title_bar_layout.addWidget(self.search_area_frame)

        #ADD LINE EDIT 
        self.line_edit_search = PyLineEdit(
            text = "",
        ...
        #self.line_edit_search.setMinimumHeight(40)
        self.line_edit_search.setMaximumHeight(0)
        #self.search_area_frame.setMinimumHeight(40)
        #$self.search_area_frame.setMaximumHeight(0)
        self.content_area_search_layout.addWidget(self.line_edit_search)
